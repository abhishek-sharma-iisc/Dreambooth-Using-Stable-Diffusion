...
class callbacks():
    ...
    def __init__(self, config: abhishekDreamboothConfigSchemaV1):
        self.config = config
...
def get_dreambooth_model_config(config: abhishekDreamboothConfigSchemaV1) -> dict:
    return {
...
def get_dreambooth_data_config(config: abhishekDreamboothConfigSchemaV1) -> dict:
    reg_block = {
...
def get_dreambooth_lightning_config(config: abhishekDreamboothConfigSchemaV1) -> dict:
    cb = callbacks(config)
    lightning_config = {
        "modelcheckpoint": {
            "params": {
...
def get_dreambooth_trainer_config(config: abhishekDreamboothConfigSchemaV1, model, lightning_config) -> dict:
    cb = callbacks(config)
    trainer_config = {
        "logger": {
...
def get_dreambooth_trainer_kwargs(config: abhishekDreamboothConfigSchemaV1, trainer_config, callbacks_config) -> dict:
    trainer_kwargs = dict()
...
def get_dreambooth_callbacks_config(config: abhishekDreamboothConfigSchemaV1, model_data_config,
